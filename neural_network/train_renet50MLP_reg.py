...
parser.add_argument("--dataset",type=str,default="/neural_network/datatestset_reg")
...
parser.add_argument("--exp_postfix",type=str,default="result_test3")
parser.add_argument("--txt_name",type=str,default="lr0.0001_wdSe-4")
parser.add_argument("--mode",type=int,default=1)
args = parser.parse_args()
image_dir = "/mnt/d/test_imag"
output_dir = "datatestset_reg"
train_ratio = 0.8
file_path = '/home/liushuai/seed/seedprosessing/sorted_output.xlsx'
train_dir = '/home/liushuai/seed/neural_network/datatestset_reg/train'
test_dir = '/home/liushuai/seed/neural_network/datatestset_reg/test'
#####################################################################################

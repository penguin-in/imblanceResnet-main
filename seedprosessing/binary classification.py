#Using image-derived morphological features and physical weight to forecast plant seed vigor.
import cv2
import re
import numpy as np
import os
...
for filename in image_files:
    ...
    weight_inf = np.array([weight[weigth_idx],weight[weigth_idx]/features[0]*1000000])
